...
Welcome to `@heyframe/api-gen` CLI.
Generate TypeScript schemas from Shopware OpenAPI specification.

After generating schemas, you can use them in fully typed [API Client](https://www.npmjs.com/package/@heyframe/api-client).
...
<!-- automd:pm-install name="@heyframe/api-gen" dev -->
...
Full changelog for stable version is available [here](https://github.com/heyframe/frontends/blob/main/packages/api-gen/CHANGELOG.md)
